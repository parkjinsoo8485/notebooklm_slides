...
* **받침 'ㅊ' 연음 및 음가 교정 (제13항)**:
  * `달빛` ➔ **[달삣]** (TTS 입력: `달삣` / 음절 말 종성 음가 또렷하게 실현) ⚠️
  * `달빛 아래` ➔ **[달삣 아래]** (TTS 입력: `달삣 아래` / 어휘 독립 분절로 의미 전달력 극대화)
...
### [제17항] 구개음화 및 ㅌ 받침 모음 연음 (ㄷ, ㅌ 받침)
받침 'ㄷ, ㅌ(ㄾ)'이 모음 '이'나 반모음 'ㅣ'로 시작되는 형식 형태소와 만나면 [ㅈ, ㅊ]으로 발음하며, 모음 조사와 결합 시 ㅌ 음가를 살려 연음한다.
* `갈대밭을` ➔ **[갈대받츨]** (TTS 입력: `갈대받츨` / 명확한 ㅌ 종성 연음) ⚠️
